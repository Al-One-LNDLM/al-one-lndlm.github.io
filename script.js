...
function updateMobileIntroArrowPosition() {
  ...
  const buttonTopOffset = imageRect.top - introRect.top - buttonHeight - 80;
  const arrowTopOffset = imageRect.bottom - introRect.top + 120;
...
function resetMobileMusicPopup() {
  ...
  introText.textContent = 'Si te interesa mi sonido, /n aquí tienes una selección de covers, instrumentales y pruebas que he hecho últimamente:';
